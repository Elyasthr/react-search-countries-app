...
const SearchBar = ({onChanger}) => {
  ...
  return (
    <form className='searchbar' onSubmit={onSubmit}>
      ...
      <input className='searchbar-input' type='text' placeholder='Search for a country…' onChange={handleChange} value={countrySearch}/>
    </form>
  );
};
